  ...
  <div v-loading="loading" class="settings-page art-full-height">
    ...
    <div class="grid"
      ><ElCard shadow="never" class="panel"
        ...
        ><SettingsBlock
          :editing="editing"
          v-model:data="setting.risk"
          :fields="riskFields" /></ElCard
      ><ElCard shadow="never" class="panel"
        ><template #header
          ><SectionTitle
            mark="▣"
      ...
      ><ElCard shadow="never" class="panel"
        ...
        ><SettingsBlock
          :editing="editing"
          v-model:data="setting.stockSync"
      ...
      ><ElCard shadow="never" class="panel"
        ...
        ><SettingsBlock
          :editing="editing"
          v-model:data="setting.limits"
          :fields="limitFields" /></ElCard
      ><ElCard shadow="never" class="panel"
        ><template #header
          ><SectionTitle
            mark="⚙"
        ...
        ><SettingsBlock
          :editing="editing"
          v-model:data="setting.links"
          :fields="linkFields" /></ElCard
    ></div>
